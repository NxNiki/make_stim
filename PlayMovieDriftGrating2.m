...
trial_onset = cumsum(rand(NumTrials,1)+ITI+StimDuration)-StimDuration+TriggerDuration;
try
    ...
    vbl=Screen('Flip', w);
    vbl_start=Screen('Flip', w, vbl+TriggerDuration);
    ...
    for i_trial = 1:NumTrials
        ...
        for i=1:framesPerTrial
            ...
            if i==1
                vbl = Screen('Flip', w, vbl_start+trial_onset(i_trial));
    ...
    save(['Onset',datestr(date,'yyyymmddTHHMMSS')],'trial_onset')
